...
import { ChartNoAxesCombined, CheckCheck, CircleHelp, Clock3, Target } from 'lucide-vue-next'
...
<template>
  ...
  <div class="info-note record-note">
    <CircleHelp :size="18" />
    <p>
      人工复核有效率只反映已复核预警，不等同于模型准确率或召回率。视频按抽帧目标关联计数，长时间遮挡或快速运动可能产生重复记录。离线质量评估需使用独立标注测试集。
    </p>
  </div>
</template>
