...
public class InspectionRepository {
    ...
    public void complete(String id, Map<String,Object> result, long elapsed, List<Map<String,Object>> detections) {
        ...
        for (Map<String,Object> d : detections) {
            ...
            db.update("INSERT INTO warning_event (id,task_id,track_key,category,label,confidence,risk,frame_time,snapshot,box_json,advice) VALUES (?,?,?,?,?,?,?,?,?,?,?)",
                UUID.randomUUID().toString(),id,d.get("trackKey"),d.get("category"),d.get("label"),d.get("confidence"),d.get("risk"),d.get("frameTime"),d.get("snapshot"),encode(d.get("box")),d.get("advice"));
        }
